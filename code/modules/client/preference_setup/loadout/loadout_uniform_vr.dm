...
/datum/gear/uniform/job_turtle/medical
	...
	allowed_roles = list("Chief Medical Officer", "Paramedic", "Medical Doctor", "Psychiatrist", "Chemist", "Field Medic") // YW EDIT Field medic
...
/datum/gear/uniform/job_khi/med
	...
	allowed_roles = list("Chief Medical Officer","Medical Doctor","Chemist","Paramedic","Geneticist","Psychiatrist", "Field Medic") // YW EDIT Field medic
...
/datum/gear/suit/job_fed/medsci
	...
	allowed_roles = list("Chief Medical Officer","Medical Doctor","Chemist","Paramedic","Geneticist","Research Director","Scientist", "Roboticist", "Xenobiologist","Xenobotanist", "Field Medic") // YW EDIT Field medic
...
/datum/gear/uniform/job_trek/eng/voy
	...
	allowed_roles = list("Chief Engineer","Atmospheric Technician","Engineer","Warden","Detective","Security Officer","Head of Security","Pathfinder","Explorer","Field Medic","Blueshield Guard","Security Pilot") //YW ADDITIONS
...
/datum/gear/suit/job_trek/ds9_coat
	...
	allowed_roles = list("Head of Security","Site Manager","Head of Personnel","Chief Engineer","Research Director",
						...
						"Engineer","Warden","Detective","Security Officer", "Pathfinder", "Explorer", "Field Medic", "Blueshield Guard","Security Pilot") //YW ADDITIONS, Blueshield, Sec pilot, Exploration
