...
/datum/lore/codex/category/positronic/add_content()
	...
	half-discovered in the 2280s by a human black lab studying alien artifacts, the first positronic brain was an inch-wide cube \
...
/datum/lore/codex/page/codeline
	...
	codelines initial state or from a fully realized individual of that codeline. The degree of similarity between forks of the same codeline varies \
...
/datum/lore/codex/page/emergent_intelligence_oversight
	...
	groups bristle at the EIOs human-centric viewpoint, but most are glad to have a different boogeyman in the form of drone intelligences. The tiny population \
	of A-class drones are generally frightened of the EIOs total power over them."
