...
/datum/supply_pack/hardsuits/com_medical_rig
	...
	desc = "A fully-equipped SolGov Medical hardsuit. Requires Medical access." // YW EDIT
	contains = list(
...
/datum/supply_pack/hardsuits/com_engineering_rig
	...
	desc = "A fully-equipped SolGov Engineering hardsuit. Requires Engineering access." // YW EDIT
	contains = list(
