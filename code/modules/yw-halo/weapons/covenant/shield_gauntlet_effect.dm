...
/obj/item/gauntlet_shield //The shield object that appears when you activate the gauntlet.
...
/obj/item/gauntlet_shield/New(var/loc, var/obj/created_by)
	. = ..()
	creator_gauntlet = created_by

/obj/item/gauntlet_shield/equipped(var/mob/living/carbon/human/user)
...
/obj/item/gauntlet_shield/dropped()
	creator_gauntlet.hand_dropped()
	. = ..()
	qdel(src)

/obj/item/gauntlet_shield/shield_gauntlet/examine(var/mob/user)
