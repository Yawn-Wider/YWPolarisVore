/obj/item/encryptionkey/heads/hop
	...
	channels = list(CHANNEL_SUPPLY = 1, CHANNEL_SERVICE = 1, CHANNEL_COMMAND = 1, CHANNEL_SECURITY = 1) //YW Edit: removes Explorer channel access, not in line with our chain of command.
...
/obj/item/encryptionkey/heads/rd
	...
	channels = list(CHANNEL_COMMAND = 1, CHANNEL_SCIENCE = 1, CHANNEL_EXPLORATION = 1) //YW Edit: adds Explorer channel access, to come in line with our chain of command.
...
/obj/item/encryptionkey/pathfinder
	...
	channels = list(CHANNEL_EXPLORATION = 1) //YW Edit: removes command channel access, not in line with our chain of command.

/obj/item/encryptionkey/qm
	name = "quartermaster's encryption key"
	icon_state = "qm_cypherkey"
	channels = list(CHANNEL_SUPPLY = 1) //YW Edit: removes command channel access, not in line with our chain of command.
