...
/datum/gear/suit/paramedic_coat
	...
	allowed_roles = list(JOB_CHIEF_MEDICAL_OFFICER,JOB_PARAMEDIC,JOB_MEDICAL_DOCTOR, "Field Medic") // YW EDIT Field medic
...
/datum/gear/suit/armor/combat/crusader_explo
	...
	//allowed_roles = list(JOB_EXPLORER,JOB_PATHFINDER, "Field Medic") // YW EDIT Field medic
...
/datum/gear/suit/armor/combat/crusader_explo/FM
	...
	allowed_roles = list (JOB_PARAMEDIC, "Field Medic") // YW EDIT Field medic
