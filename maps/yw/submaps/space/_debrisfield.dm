...
/area/cryogaia_away/debrisfield
	name = "Away Mission - Debris Field"
	icon = 'icons/turf/areas_vr.dmi'
	icon_state = "dark"

/area/cryogaia_away/debrisfield/shuttle_buffer //For space around shuttle landmarks to keep submaps from generating to block them
