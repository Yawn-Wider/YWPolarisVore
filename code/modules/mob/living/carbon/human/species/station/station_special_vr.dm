...
/datum/species/xenochimera //Scree's race.
	...
	wikilink = "https://yawn.izac.live/wiki/Xenochimera"
	...
	spawn_flags = SPECIES_CAN_JOIN // YW EDIT Comment out | SPECIES_IS_WHITELISTED | SPECIES_WHITELIST_SELECTABLE//Whitelisted as restricted is broken.
...
/datum/species/spider //These actually look pretty damn spooky!
	...
	wikilink = "https://yawn.izac.live/wiki/Vasilissans"
