...
/obj/machinery/atmospherics/unary/vent_pump/siphon/on/atmos/cryogaia // YW ADDITION relief vent, that connects to the waste line as a subtype to make it easier to map in
	name = "Relief vent"
