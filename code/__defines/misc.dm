...
#define TEMPERATURE_SHIELDED 		0x4000 // YW Addition: Temperature change shielding
#define PHASE_SHIELDED				0x8000 // YW Addition: Prevents shadekin phasing in/out in this area
