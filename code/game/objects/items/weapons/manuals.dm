...
/obj/item/book/manual/engineering_construction/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
...
/obj/item/book/manual/engineering_hacking/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
...
/obj/item/book/manual/robotics_manual/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
		<html><head>
		</head>
...
/obj/item/book/manual/security_space_law/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
...
/obj/item/book/manual/medical_diagnostics_manual/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"<html>
				<head>
				<style>
...
/obj/item/book/manual/engineering_guide/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
