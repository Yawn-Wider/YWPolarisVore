...
#define Z_LEVEL_SUBTERRAIN_OUTPOST					1
#define Z_LEVEL_SURFACE_OUTPOST						2
#define Z_LEVEL_UPPER_FLOORS_OUTPOST				3
#define Z_LEVEL_ORBITAL_COMMAND_OUTPOST				4
#define Z_LEVEL_CENTCOMM_OUTPOST					5
#define Z_LEVEL_EMPTY_								6
...
/datum/map/outpost
	...
	dock_name     = "SL-340 Local System Spaceport"
	...
	shuttle_docked_message = "The scheduled shuttle to the %dock_name% has docked with the orbital station. It will depart in approximately %ETD%."
	shuttle_leaving_dock = "The Crew Transfer Shuttle has left the station. Estimate %ETA% until the shuttle docks at %dock_name%."
	shuttle_called_message = "A crew transfer to %dock_name% has been scheduled. The shuttle has been called. Those leaving should proceed to the orbital station dock in approximately %ETA%."
	shuttle_recall_message = "The scheduled crew transfer has been cancelled."
	emergency_shuttle_docked_message = "The Emergency Shuttle has docked at the orbital station. You have approximately %ETD% to board the Emergency Shuttle."
	emergency_shuttle_leaving_dock = "The Emergency Shuttle has left the station. Estimate %ETA% until the shuttle docks at %dock_name%."
	emergency_shuttle_called_message = "An emergency evacuation shuttle has been called. It will arrive at the orbital station dock in approximately %ETA%."
...
//							NETWORK_HALLWAYS,
	...
	allowed_spawns = list("Arrivals Shuttle", /*"Gateway", Intentionally no gateway - Ignus*/ "Cryogenic Storage", "Cyborg Storage")
...
/datum/map/northern_star/perform_map_generation()
	...
	return 1
*/ //No mining, keeping code incase it fucks things - Ignus


/datum/map_z_level/outpost/main
	z = Z_LEVEL_ORBITAL_COMMAND_OUTPOST
	name = "Main"
...
/datum/map_z_level/northern_star/empty
	...
	flags = MAP_LEVEL_PLAYER
	transit_chance = 60
*/ //Temporarily removed until the map is more finalized
