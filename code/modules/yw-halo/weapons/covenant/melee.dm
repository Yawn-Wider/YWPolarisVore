...
/obj/item/weapon/melee/energy/elite_sword
	...
	icon = 'code/modules/yw-halo/weapons/icons/Covenant Weapons.dmi'
...
/obj/item/weapon/melee/energy/elite_sword/proc/change_misc_variables(var/deactivate = 0)
	if(deactivate)
		...
		item_icons = list(slot_l_hand_str ='code/modules/yw-halo/icons/Energy Sword_inhand Human.dmi',slot_r_hand_str = 'code/modules/yw-halo/icons/Energy Sword_inhand Human.dmi')
