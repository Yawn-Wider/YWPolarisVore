...
/obj/item/book/manual/standard_operating_procedure/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
...
/obj/item/book/manual/command_guide/New() // YW EDIT: adds index.php?title= to dat
	..()
	dat = {"
