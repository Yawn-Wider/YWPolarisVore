...
/obj/machinery/photocopier/faxmachine/proc/send_admin_fax(var/mob/sender, var/destination)
	...
	if(destination == using_map.boss_name)
		...
		message_admins(sender, "Solar Central Government FAX", rcvdcopy, "CentComFaxReply", "#1F66A0") // YW EDIT
 ...
 */
/obj/machinery/photocopier/faxmachine/proc/message_chat_rolerequest(message_color, ping_name, reason, role) // YW EDIT: replaces the voerestation rolerequest webhook
	SSwebhooks.send(
		WEBHOOK_ROLEREQUEST,
		list(
