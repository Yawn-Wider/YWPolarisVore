...
/datum/gear/eyes/meson
	...
	allowed_roles = list(JOB_ENGINEER,JOB_CHIEF_ENGINEER,JOB_ATMOSPHERIC_TECHNICIAN, JOB_SCIENTIST, JOB_RESEARCH_DIRECTOR, "Explorer", "Pathfinder", "Field Medic") // YW EDIT Field medic, Explo
