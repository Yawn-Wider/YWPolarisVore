...
/datum/gear/head/med_hat_selector
	...
	allowed_roles = list(JOB_CHIEF_MEDICAL_OFFICER,JOB_MEDICAL_DOCTOR,JOB_CHEMIST,JOB_PSYCHIATRIST,JOB_PARAMEDIC,"Blueshield Guard","Security Pilot") //YW ADDITIONS
