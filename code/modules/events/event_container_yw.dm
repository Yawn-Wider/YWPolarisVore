...
//
// VOREStation overrides to the default event manager configuration. - YW Version, do not have both vr and yw containers at once
//
...
/datum/event_container/mundane/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Lost Spiders",		/datum/event/spider_migration, 	0, 		list(ASSIGNMENT_SECURITY = 10), 1),
...
/datum/event_container/moderate/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Lost Spiders",				/datum/event/spider_migration,			0, 		list(ASSIGNMENT_SECURITY = 30), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Supply Demand",			/datum/event/supply_demand,				0,		list(ASSIGNMENT_ANY = 5, ASSIGNMENT_SCIENCE = 15, ASSIGNMENT_GARDENER = 10, ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_MEDICAL = 15), 3),
	)
	add_disabled_events(list(
...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Disease Outbreak", 		/datum/event/disease_outbreak, 	0,		list(ASSIGNMENT_MEDICAL = 30), 2),
	)
	add_disabled_events(list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Blob",				/datum/event/blob, 				10,		list(ASSIGNMENT_ENGINEER = 60), 3),
